...
Revision ID: 10061eeeab3b
Revises: fe8ca2fa0a22
Create Date: 2026-09-17 08:55:51.637823
"""
...
revision: str = '10061eeeab3b'
down_revision: str | Sequence[str] | None = 'fe8ca2fa0a22'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('type', sa.Enum('ACCESS', 'REFRESH', name='authtokentype'), nullable=False),
...
def downgrade() -> None:
    ...
    sa.Enum('ACCESS', 'REFRESH', name='authtokentype').drop(op.get_bind())
